...
func TestUnlock(t *testing.T) {
	...
	locationsModule:= LocationsModule{config, testProvider}
	result:=locationsModule.Unlock(TEST_USER_ID,LocationUnlockRequest{
	...
	if result:= locationsModule.Unlock(TEST_USER_ID,LocationUnlockRequest{
		LocationName: "stars", ResourceName: "coins",
...
func TestUpgrade(t *testing.T) {
	...
	testProvider:=NewTestDataProvider()
	locationsModule:= LocationsModule{Config: config, Provider: testProvider}

	log.Printf("[test] not existing item")
	if result:= locationsModule.Upgrade(TEST_USER_ID, ItemUpgradeRequest{
		LocationName: "stars", ResourceName: "coins",
